...
public class TesteFolha {
    public static void main(String[] args) {
        ...
        try {
            ...
            fpa.setSalario(2700.8);
            dados[0] = fpa;

            FComissionado fco = new FComissionado();
            fco.setMatricula(2);
            fco.setNome("Sivaldo Oliveira");
            fco.setSalario(2000);
            ...
            fpr.setMatricula(3);
            fpr.setNome("Mauriza Oliveira");
            fpr.setSalario(3000);
            fpr.setProducao(1500);
            fpr.setValor(0.5);
            dados[2] = fpr;
        } catch (EDadoInvalido di) {
            JOptionPane.showMessageDialog(null, di.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
            System.exit(0);
