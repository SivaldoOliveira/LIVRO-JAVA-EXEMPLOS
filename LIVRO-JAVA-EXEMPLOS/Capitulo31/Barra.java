...
public class Barra extends JFrame implements ActionListener {
    ...
    public Barra() {
        ...
        btUsuario.setToolTipText("Cadastro de usuários");
        ...
        btSistema.setToolTipText("Configurações do sistema");
        ...
        btSobre.setToolTipText("Informações sobre o sistema");
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == miOeste)
            if (miOeste.isSelected())
                add(tbOeste, BorderLayout.WEST);
            else
                remove(tbOeste);
        else if (e.getSource() == miNorte)
            if (miNorte.isSelected())
                add(tbNorte, BorderLayout.NORTH);
            else
                remove(tbNorte);
