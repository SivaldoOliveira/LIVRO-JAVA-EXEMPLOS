...
public class TrocaAtleta {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            int i = showOptionDialog(null, "Escolha uma opção", "Ordenação por Troca - Atletas", 0, 3, null,
    ...
    private static void incluir() {
        ...
        String str = showInputDialog("Infomre o número do atleta");
        if (str == null)
            return;
        try {
            att.setNumero(str);
    ...
    private static void ordenar() {
        ...
        showMessageDialog(null, "Ordenação concluída!");
    }

    private static void listar() {
        if (qtde == 0) {
            showMessageDialog(null, "Não dados!", "Erro", ERROR_MESSAGE);
            return;
        }
