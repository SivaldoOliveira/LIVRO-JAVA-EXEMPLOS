...
public class ExemploLinkedList {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            int i = showOptionDialog(null, "Escolha uma opção", "Cadastro de contatos", 0, 3, null,
                    new String[] { "Incluir", "Excluir", "Consultar", "Relatório" }, "Incluir");
            if (i == -1)
                System.exit(0);
            if (i == 0)
                incluir();
    ...
    private static void incluir() {
        ...
        int i = showOptionDialog(null, "Escolha o local da inclusão", "Cadastro de contatos", 0, 3, null,
                new String[] { "Início", "Final" }, "Final");
        if (i == 0)
            lista.addFirst(contato);
        else if (i == 1)
            lista.addLast(contato);
    }
    ...
    private static void excluir() {
        ...
        int i = showOptionDialog(null, "Escolha o local da exclusão", "Cadastro de contatos", 0, 3, null,
                new String[] { "Início", "Final" }, "Final");
        if (i == 0)
            contato = lista.removeFirst();
        else if (i == 1)
            contato = lista.removeLast();
    ...
    private static void consultar() {
        ...
        int i = showOptionDialog(null, "Escolha o local da consulta", "Cadastro de contatos", 0, 3, null,
                new String[] { "Início", "Final" }, "Final");
        if (i == 0)
            contato = lista.getFirst();
        else if (i == 1)
            contato = lista.getLast();
