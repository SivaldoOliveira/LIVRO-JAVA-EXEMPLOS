...
public class ExemploFilaPrioridade {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            str = showInputDialog(null, "Selecione a prioridade", "", 3, null,
                    new String[] { "Mínima", "Pequena", "Média", "Alta", "Altíssima" }, "Mínima").toString();
            if (str == null)
                break;
            for (Gravidade g : Gravidade.values())
                if (g.getDescricao().equals(str))
                    paciente.setGravidade(g);
