...
public abstract class Funcionario {
    ...
    public void setMatricula(int matricula) throws EDadoInvalido {
        if (matricula <= 0)
            throw new EDadoInvalido("A matricula deve ser positiva");
    ...
    public void setMatricula(String matricula) throws EDadoInvalido {
        try {
            ...
            throw new EDadoInvalido("A matricula deve ser um inteiro");
        }
    }
    ...
    public String toString() {
        ...
        return "Funcionário " + matricula + ": " + nome + " - " + nf.format(salario) + "+ " + nf.format(diferenca)
                + " = " + nf.format(total);
    }
}
